...
//
//template<class Node,int Dim=3>
//struct IteratorDfs : public iterator_base<Node>
//{
//public:
//    using key_type = Key<Dim>;
//    using iterator_base_type = iterator_base<Node>;
//    using node_type = typename iterator_base_type::node_type;
//    IteratorDfs(const IteratorDfs&) noexcept = default;
//    IteratorDfs(IteratorDfs&&) noexcept = default;
//
//    IteratorDfs& operator=(IteratorDfs other) noexcept
//    {
//        swap(*this,other);
//        return *this;
//    }
...
//
//template<class Node,int Dim=3>
//struct IteratorBfs : public iterator_base<Node>
//{
//public:
//    using key_type = Key<Dim>;
//    using iterator_base_type = iterator_base<Node>;
