...
void dfft_r2c::execute_whole()
{
    fftw_execute(plan);
}

void dfft_r2c::execute()
{
    //Fisrt direction
...
void dfft_r2c::copy_input(const Vector& _v, dims_t _dims_v)
{
...
void Convolution::simd_prod_complex_add(const complex_vector_t& a,
...
Convolution::complex_vector_t& Convolution::dft_r2c(std::vector<float_type>& _vec )
{
    fft_forward0_.copy_input(_vec, dims0_);
    fft_forward0_.execute_whole();
    return fft_forward0_.output();
}
void Convolution::fft_backward_field_clean()
{
