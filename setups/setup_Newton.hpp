...
class SetupNewton
: private crtp::Crtps<Setup, SetupNewton<Setup, SetupTraits>>
, public SetupTraits
{
  ...
  public: //default fields
    ...
    (
      ...
      //Fields for Jacobian
      (u_i_bc,              float_type,  Dim,  1,  1,  face,true),
  ...
  public: //Ctors
    ...
    SetupNewton(Dictionary* _d, domaint_init_f _fct,
