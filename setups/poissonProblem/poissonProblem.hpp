...
: public SetupBase<PoissonProblem, ParametersPoissonProblem>
{
  public: //member types
  ...
  public: //Ctor
    ...
    void initialize()
    {
        ...
        const int nRef =
            this->simulation_.dictionary_->template get_or<int>("nLevels", 0);
    ...
    void compute_errors()
    {
             ...
             ++it_t)
        {
                 ...
                 ++it2)
            {
                ...
                if (abs(error_tmp) > LInf) LInf = abs(error_tmp);
             ...
             ++it_t)
        {
                 ...
                 ++it2)
            {
                ...
                if (abs(error_tmp) > LInf_source) LInf_source = abs(error_tmp);
