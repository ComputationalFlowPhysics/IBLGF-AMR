#ifndef IBLGF_INCLUDED_HDF5READ_HPP
#define IBLGF_INCLUDED_HDF5READ_HPP
...
struct parameters
{
    ...
    REGISTER_FIELDS(Dim, ((field, float_type, 1, 1, 1, cell),
...
struct HDF5Read : public SetupBase<HDF5Read, parameters>
{
    using super_type = SetupBase<HDF5Read, parameters>;

    HDF5Read(Dictionary* _d)
    ...
    })
    {
        ...
        filename_ = simulation_.dictionary_->template get_or<std::string>(
            "hdf5_file_name", "null");
