...
public:  //Registry
    ...
    void register_sendMap(sendMap_functor_t _f) noexcept
    {
        sendMap_=_f;
    }

    void register_recvMap(recvMap_functor_t _f)  noexcept
    {
        recvMap_=_f;
    }

    void register_completeFunc(complete_functor_t _f)
    {
        complete_=_f;
    }
...
public: //Ctor
    ...
    :send_data_(_size), recv_data_(_size)
    {}
